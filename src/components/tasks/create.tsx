...
export default function CreateTask() {
  ...
  return <>
    ...
    <div className="max-w-screen-xl mx-auto">
      <TaskForm defaultValues={{ creator: {user: {name: (user && user.fullName) || ''}}, deadline: parent ? parent.deadline : new Date(), name: parent ? parent.name : '', source: parent ? parent.source : '' }}></TaskForm>
    </div>
